...
(function () {
  ...
  */
  ...
  governing permissions and limitations under the License.
  */
  var highEntropyUserAgentHints$1 = ["architecture", "bitness", "model", "platformVersion", "wow64"];
  ...
  */
  ...
  var injectHighEntropyUserAgentHints = (function (navigator) {
    ...
    return function (xdm, logger) {
      try {
        return navigator.userAgentData.getHighEntropyValues(highEntropyUserAgentHints$1).then(function (hints) {
          var userAgentClientHints = {};
          highEntropyUserAgentHints$1.forEach(function (hint) {
